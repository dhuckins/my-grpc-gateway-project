...
var (
	filter_KvService_Put_0 = &utilities.DoubleArray{Encoding: map[string]int{"name": 0}, Base: []int{1, 1, 0}, Check: []int{0, 1, 2}}
)
...
func request_KvService_Put_0(ctx context.Context, marshaler runtime.Marshaler, client KvServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_KvService_Put_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
...
func RegisterKvServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server KvServiceServer) error {
	...
	mux.Handle("POST", pattern_KvService_Put_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/api.v1.KvService/Put", runtime.WithHTTPPathPattern("/kv/v1/put/{name}"))
		if err != nil {
	...
	mux.Handle("GET", pattern_KvService_Get_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/api.v1.KvService/Get", runtime.WithHTTPPathPattern("/kv/v1/get/{name}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterKvServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client KvServiceClient) error {
	...
	mux.Handle("POST", pattern_KvService_Put_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/api.v1.KvService/Put", runtime.WithHTTPPathPattern("/kv/v1/put/{name}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_KvService_Get_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/api.v1.KvService/Get", runtime.WithHTTPPathPattern("/kv/v1/get/{name}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_KvService_Put_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"kv", "v1", "put", "name"}, ""))

	pattern_KvService_Get_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"kv", "v1", "get", "name"}, ""))
)
